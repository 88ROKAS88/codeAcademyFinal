...
const allMaps = [
    {
        map: [
            5, 11, 17, 23, 29, 35, 41, 47, 53, 59, 65, 64, 63, 62, 61, 60, 4, 3,
            2, 1, 0, 6, 12, 18, 24, 30, 36, 42, 48, 54, 21, 8, 27, 26, 25, 40,
            39, 38, 44, 57,
        ],
        player: [100, 100],
        exit: 58,
    ...
    {
        map: [
            5, 4, 3, 2, 1, 0, 6, 12, 18, 24, 30, 36, 42, 48, 54, 60, 64, 63, 62,
            61, 14, 27, 33, 32, 44, 50, 56, 45, 46,
        ],
        player: [900, 100],
        exit: 65,
        pigin: [1000, 400],
    ...
    {
        map: [
            5, 4, 3, 2, 0, 6, 12, 18, 24, 30, 36, 42, 48, 54, 60, 65, 64, 63,
            62, 61, 57, 59, 47, 41, 59, 53, 40, 13, 14, 15, 21, 32, 39, 38,
        ],
        player: [900, 400],
        exit: 1,
        pigin: [0, 0],
